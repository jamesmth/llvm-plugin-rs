...
mod plugin {
    ...
    #[pass(name = "string-obfuscator-pass")]
    ...
    fn create_decode_fn<'a>(module: &mut Module<'a>) -> FunctionValue<'a> {
        ...
        let var12 =
            builder.build_int_add(var11.into_int_value(), cx.i8_type().const_all_ones(), "");
    ...
    fn create_decode_stub<'a>(
        ...
        let decode_stub =
            module.add_function("decode_stub", cx.void_type().fn_type(&[], false), None);
